...
# ![](ASSETS/encapsule-holistic-32x32.png)&nbsp;Holistic App Platform v0.1.05 phoenix
...
```
Package: @encapsule/holistic v0.1.05 "phoenix" build ID "HedsjSNAQqKZLbejVGDmDQ"
Sources: @encapsule/holodev#b0feffd764521ea465f7e9f203b3786cd28e80af
Created: 2021-06-21T15:44:10.000Z Purpose: tools (Node.js) License: MIT
```
